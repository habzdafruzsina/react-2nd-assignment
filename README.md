...
ELTE IK
_Kliensoldali webprogramozás 2. beadandó 2023-24-2_
_tárgyfelelős: Horváth Győző_

## Élő alkalmazás

[Stackblitz](https://stackblitz.com/edit/vitejs-vite-nly2bt)
...
megjegyzés: félek, hogy itt a szerver oldali végpont hibás (nekem sehogy nem sikerült lekérnem vele adatot)
...
Megjegyzés:
mivel kissé pontatlan a feladatleírás (utalok itt pl az illusztrációkra, melyek nem feltétlen felelnek meg a kikötéseknek, esetenként más elemeket is tartalmaznak, stb.), előfordulhat, hogy olyat pontot jelöltem be elkészültként, ami nem megfelelően/elvárásnak megfelelően lett megvalósítva